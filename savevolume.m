function savevolume(savefolder, centroidr, centroidc, central)
...
% frustum-shaped compartment of the LEGO phantom before the main analysis 
% loop.
%
...
centralpath = fullfile(savefolder, 'a_central_slice.png');
imwrite(central, centralpath); 
